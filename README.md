...
- [Deconstructing SPF Records with Rust using Generics - Dev.to](https://dev.to/basman/deconstructing-spf-with-rust-using-generics-nop)

- [Manage Rust Code by Breaking it Up - Personal Blog](https://bas-man.github.io/post/manage-rust-code-by-breaking-it-up/#)
- [Manage Rust Code by Breaking it Up - Dev.to](https://dev.to/basman/manage-rust-code-by-breaking-it-up-37o9)
