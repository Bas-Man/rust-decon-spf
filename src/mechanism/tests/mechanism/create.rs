...
mod a {
    ...
    fn create_a_with_rrdata() {
        ...
        let a_mechanism = Mechanism::create_a(Qualifier::Fail).with_rrdata(&string);
        match a_mechanism {
            Ok(m) => {
    ...
    fn create_a_with_bad_rrdata() {
        let a_mechanism = Mechanism::create_a(Qualifier::Fail).with_rrdata("example.xx");
        match a_mechanism {
            Ok(_) => {}
            Err(e) => {
                assert_eq!(
    ...
    fn create_a_with_bad_rrdata_2() {
        match Mechanism::create_a(Qualifier::Fail).with_rrdata("example.xx") {
            Ok(_) => {}
            Err(e) => {
                assert_eq!(
                    e,
...
mod mx {
    ...
    fn create_mx_with_rrdata_match() {
        let mx = Mechanism::create_mx(Qualifier::Neutral).with_rrdata("example.com");
        match mx {
            Ok(mx) => {
                assert_eq!(mx.is_neutral(), true);
                assert_eq!(mx.raw(), "example.com");
    ...
    fn create_mx_with_bad_rrdata_match() {
        let mx = Mechanism::create_mx(Qualifier::Neutral).with_rrdata("example.xx");
        match mx {
            Ok(_) => {}
            Err(e) => {
                assert_eq!(
    ...
    fn create_mx_with_rrdata_match2() {
        match Mechanism::create_mx(Qualifier::Neutral).with_rrdata("example.com") {
            Ok(mx) => {
                assert_eq!(mx.is_neutral(), true);
                assert_eq!(mx.raw(), "example.com");
                assert_eq!(mx.to_string(), "?mx:example.com");
    ...
    fn create_mx_with_bad_rrdata_match2() {
        match Mechanism::create_mx(Qualifier::Neutral).with_rrdata("example.xx") {
            Ok(_) => {}
            Err(e) => {
                assert_eq!(
                    e,
...
mod exists {
    ...
    #[test]
    fn exists_pass() {
        let exists = Mechanism::create_exists(Qualifier::Neutral, "bogus.com").unwrap();
...
mod include {
    ...
    #[test]
    fn include_pass() {
        let include = Mechanism::create_include(Qualifier::Pass, "_spf.test.com").unwrap();
    ...
    #[test]
    fn include_fail() {
        let include = Mechanism::create_include(Qualifier::Fail, "_spf.test.com").unwrap();
        assert_eq!(include.is_fail(), true);
        assert_eq!(include.to_string(), "-include:_spf.test.com");
    }
    #[test]
    fn include_softfail() {
        let include = Mechanism::create_include(Qualifier::SoftFail, "_spf.test.com").unwrap();
        assert_eq!(include.is_softfail(), true);
        assert_eq!(include.to_string(), "~include:_spf.test.com");
    }
    #[test]
    fn include_neutral() {
        let include = Mechanism::create_include(Qualifier::Neutral, "_spf.test.com").unwrap();
...
mod redirect {
    ...
    #[test]
    fn test_redirect() {
        let redirect = Mechanism::create_redirect(Qualifier::Pass, "_spf.example.com").unwrap();
    ...
    fn redirect_invalid_rrdata() {
        if let Err(redirect) = Mechanism::create_redirect(Qualifier::Pass, "_spf.example.") {
            assert_eq!(
                redirect,
