...
mod A {
    ...
    use crate::mechanism::{Kind, MechanismImpl, Qualifier};

    #[test]
    fn new_a_without_mechanism() {
        let a_mechanism = MechanismImpl::new_a_without_mechanism(Qualifier::Fail);
    ...
    fn new_a_with_mechanism() {
        let a_mechanism =
            MechanismImpl::new_a_with_mechanism(Qualifier::Fail, "example.com".to_string());
        assert_eq!(a_mechanism.is_fail(), true);
        assert_eq!(a_mechanism.kind(), &Kind::A);
...
mod MX {
    ...
    fn new_mx_without_mechanism() {
        let mx = MechanismImpl::new_mx_without_mechanism(Qualifier::Pass);
    ...
    fn new_mx_without_mechanism_softfail() {
        let mx = MechanismImpl::new_mx_without_mechanism(Qualifier::SoftFail);
    ...
    fn new_mx_with_mechanism() {
        let mx =
            MechanismImpl::new_mx_with_mechanism(Qualifier::Neutral, String::from("example.com"));
...
mod EXISTS {
    ...
    #[test]
    fn exists_pass() {
        let exists = MechanismImpl::new_exists(Qualifier::Neutral, String::from("bogus.com"));
...
mod INCLUDE {
    ...
    #[test]
    fn include_pass() {
        let include = MechanismImpl::new_include(Qualifier::Pass, String::from("_spf.test.com"));
    ...
    #[test]
    fn include_fail() {
        let include = MechanismImpl::new_include(Qualifier::Fail, String::from("_spf.test.com"));
    ...
    fn include_softfail() {
        let include =
            MechanismImpl::new_include(Qualifier::SoftFail, String::from("_spf.test.com"));
        assert_eq!(include.is_softfail(), true);
        assert_eq!(include.to_string(), "~include:_spf.test.com");
    }
    #[test]
    fn include_neutral() {
        let include = MechanismImpl::new_include(Qualifier::Neutral, String::from("_spf.test.com"));
...
mod PTR {
    ...
    fn ptr_without_mechanism() {
        let ptr = MechanismImpl::new_ptr_without_mechanism(Qualifier::Pass);
    ...
    fn ptr_with_mechanism() {
        let ptr =
            MechanismImpl::new_ptr_with_mechanism(Qualifier::Neutral, String::from("example.com"));
...
mod redirect {
    ...
    fn test_redirect() {
        let redirect =
            MechanismImpl::new_redirect(Qualifier::Pass, String::from("_spf.example.com"));
...
mod Ip4 {
    ...
    #[test]
    fn ip4_pass() {
        let ip4_pass = MechanismImpl::new_ip4(Qualifier::Pass, "203.32.160.10/32".parse().unwrap());
    ...
    #[test]
    fn ip4_fail() {
        let ip4_fail = MechanismImpl::new_ip4(Qualifier::Fail, "203.32.160.10/32".parse().unwrap());
    ...
    fn ip4_softfail() {
        let ip4_softfail =
            MechanismImpl::new_ip4(Qualifier::SoftFail, "203.32.160.10/32".parse().unwrap());
    ...
    fn ip4_neutral() {
        let ip4_neutral =
            MechanismImpl::new_ip4(Qualifier::Neutral, "203.32.160.10/32".parse().unwrap());
...
mod ip6 {
    ...
    fn ip6_pass() {
        let ip_pass =
            MechanismImpl::new_ip6(Qualifier::Pass, "2001:4860:4000::/36".parse().unwrap());
    ...
    fn ip6_fail() {
        let ip_fail =
            MechanismImpl::new_ip6(Qualifier::Fail, "2001:4860:4000::/36".parse().unwrap());
    ...
    fn ip6_softfail() {
        let ip_softfail =
            MechanismImpl::new_ip6(Qualifier::SoftFail, "2001:4860:4000::/36".parse().unwrap());
    ...
    fn ip6_neutral() {
        let ip_neutral =
            MechanismImpl::new_ip6(Qualifier::Neutral, "2001:4860:4000::/36".parse().unwrap());
...
mod all {
    ...
    #[test]
    fn new_all() {
        let a_mechanism = MechanismImpl::new_all(Qualifier::Fail);
        assert_eq!(a_mechanism.is_fail(), true);
