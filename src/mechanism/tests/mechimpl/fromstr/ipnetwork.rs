...
mod valid_ip4 {
    ...
    fn basic_ip_str() {
        ...
        let m: MechanismImpl<IpNetwork> = input.parse().unwrap();
...
mod invalid_ip4 {
    ...
    use crate::mechanism::{MechanismError, MechanismImpl};
    use ipnetwork::IpNetwork;
    ...
    fn mechanism_name_malformed() {
        ...
        let m: Result<MechanismImpl<IpNetwork>, MechanismError> = input.parse();
