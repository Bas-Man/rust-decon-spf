...
fn spf_a() {
    ...
    assert_eq!(spf_as_json,
               "{\"source\":\"v=spf1 a ~all\",\"version\":\"v=spf1\",\"from_src\":false,\"redirect\":null,\"is_redirected\":false,\"a\":[{\"kind\":\"A\",\"qualifier\":\"Pass\",\"rrdata\":null}],\"mx\":null,\"include\":null,\"ip4\":null,\"ip6\":null,\"ptr\":null,\"exists\":null,\"all\":{\"kind\":\"All\",\"qualifier\":\"SoftFail\",\"rrdata\":null},\"was_parsed\":true,\"was_validated\":false,\"is_valid\":true}");
